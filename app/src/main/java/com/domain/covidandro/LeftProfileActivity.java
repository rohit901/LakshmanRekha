...
public final class LeftProfileActivity extends AppCompatActivity
        implements OnRequestPermissionsResultCallback{
    private static final String TAG = "LeftProfileActivity";
...
//        }
        ...
        setContentView(R.layout.activity_left_profile);
        ...
        try {
            switch (selectedModel) {
                case FACE_DETECTION:
                    ...
                    imageProcessor = new LeftFaceDetectorProcessor(this, faceDetectorOptions);
                    break;
                default:
