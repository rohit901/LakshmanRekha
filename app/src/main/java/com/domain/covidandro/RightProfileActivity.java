...
public final class RightProfileActivity extends AppCompatActivity
        implements OnRequestPermissionsResultCallback{
    private static final String TAG = "RightProfileActivity";
...
//        }
        ...
        setContentView(R.layout.activity_right_profile);
        ...
        try {
            switch (selectedModel) {
                case FACE_DETECTION:
                    ...
                    imageProcessor = new RightFaceDetectorProcessor(this, faceDetectorOptions);
                    break;
                default:
