...
//    }
    ...
    public void processImageProxy(ImageProxy image, GraphicOverlay graphicOverlay, ImageCapture imageCapture, ExecutorService executor, Context context) {
        if (isShutdown) {
            image.close();
            return;
        }
        ...
        return detectInImage(image)
                .addOnSuccessListener(
                        ...
                        results -> {
                            ...
                            VisionProcessorBase.this.onSuccess(results, graphicOverlay, imageCapture, executorService, context);
//                            graphicOverlay.add(
//                                    new InferenceInfoGraphic(
//                                            graphicOverlay, currentLatencyMs, shouldShowFps ? framesPerSecond : null));
//                            graphicOverlay.add(
//                                    new SmartAcquisGraphic(
//                                            graphicOverlay, currentLatencyMs, shouldShowFps ? framesPerSecond : null));
    ...
    protected abstract void onSuccess(@NonNull T results, @NonNull GraphicOverlay graphicOverlay, ImageCapture imageCapture, ExecutorService executorService, Context context);
